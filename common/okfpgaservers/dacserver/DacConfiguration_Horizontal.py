...
class hardwareConfiguration(object):
    ...
    elec_dict = {
        ...
        'T-DC1': channelConfiguration(18, trapElectrodeNumber='T-DC1'), # endcap
        'T-DC2': channelConfiguration(8, trapElectrodeNumber='T-DC2'), #endcap
        'T-DC3': channelConfiguration(12, trapElectrodeNumber='T-DC3'), #finger
        'T-DC4': channelConfiguration(9, trapElectrodeNumber='T-DC4'), #finger
        'T-DC5': channelConfiguration(6, trapElectrodeNumber='T-DC5'), #finger
        'T-DC6': channelConfiguration(10, trapElectrodeNumber='T-DC6'), #finger
        'T-DC7': channelConfiguration(11, trapElectrodeNumber='T-DC7'), #finger
        'T-DC8': channelConfiguration(21, trapElectrodeNumber='T-DC8'), #finger
        'T-DC9': channelConfiguration(22, trapElectrodeNumber='T-DC9'), #finger
        'T-DC10': channelConfiguration(23, trapElectrodeNumber='T-DC10'), #finger
        'T-DC11': channelConfiguration(24, trapElectrodeNumber='T-DC11'), #finger
        'T-DC12': channelConfiguration(25, trapElectrodeNumber='T-DC12'), #finger
        'T-DC13': channelConfiguration(20, trapElectrodeNumber='T-DC13'), #center
        'T-DC14': channelConfiguration(16, trapElectrodeNumber='T-DC14'), #center
        'T-DC15': channelConfiguration(19, trapElectrodeNumber='T-DC15'), #center
        'T-DC16': channelConfiguration(27, trapElectrodeNumber='T-DC16'), #center
        'T-RF1 bias': channelConfiguration(17, trapElectrodeNumber='T-RF1 bias'), # RF1 bias
        'T-RF2 bias': channelConfiguration(15, trapElectrodeNumber='T-RF2 bias'), # RF2 bias
