...
class KEYSIGHT_33600A(LabradServer):
    ...
    def b_field_waveform_2freq(self, phases, freqs, start_hold, on_time, end_hold):
    ...
    @setting(7, "Program B Field 2Freq", phases = '*v', center_freq = 'v', freq_sep = 'v', start_hold = 'v', on_time = 'v', end_hold = 'v',amplitude = 'v')
    def program_b_field_2freq(self, c, phases, center_freq, freq_sep, start_hold, on_time, end_hold, amplitude): #in Hz and arbitrary
        ...
        wf_str = self.b_field_waveform_2freq(phases, freqs, start_hold, on_time, end_hold)
