...
class actions_widget(QtGui.QWidget):
    def __init__(self,reactor,cxn = None, parent=None):
        ...
        # self.channel_397 = "397DP"
        # self.channel_866 = "866DP"
        # self.switch_traps = QtGui.QPushButton('From Loading')
        ...
        # self.fromload_button_extra = QtGui.QPushButton('From Loading (extra)')
        # self.fromdc_button_extra = QtGui.QPushButton('From Doppler Cooling (extra)')
        # self.fromstate_button_extra = QtGui.QPushButton('From State Detection (extra)')
        # self.toload_button_extra = QtGui.QPushButton('To Loading (extra)')
        # self.todc_button_extra = QtGui.QPushButton('To Doppler Cooling (extra)')
        # self.tostate_button_extra = QtGui.QPushButton('To State Detection (extra)')
        ...
        layout.addWidget(self.toload_button, 1, 0)
    	layout.addWidget(self.fromdc_button, 2, 0)
    	layout.addWidget(self.todc_button, 3, 0)
    	layout.addWidget(self.fromstate_button, 4, 0)
    	layout.addWidget(self.tostate_button, 5, 0)
        # layout.addWidget(self.fromload_button_extra, 0, 1)
        # layout.addWidget(self.toload_button_extra, 1, 1)
        # layout.addWidget(self.fromdc_button_extra, 2, 1)
        # layout.addWidget(self.todc_button_extra, 3, 1)
        # layout.addWidget(self.fromstate_button_extra, 4, 1)
        # layout.addWidget(self.tostate_button_extra, 5, 1)
    ...
    def connect_layout(self):
        ...
        # self.fromload_button_extra.pressed.connect(self.on_from_loading_extra)
        # self.fromdc_button_extra.pressed.connect(self.on_from_dc_extra)
        # self.fromstate_button_extra.pressed.connect(self.on_from_state_extra)
        # self.toload_button_extra.pressed.connect(self.on_to_loading_extra)
        # self.todc_button_extra.pressed.connect(self.on_to_dc_extra)
        # self.tostate_button_extra.pressed.connect(self.on_to_state_extra)
    ...
    def on_to_loading(self):
        ...
        channel_397 = "397DP"
        channel_866 = "866DP"
        ampl397 = yield pulser.amplitude(channel_397)
        ampl866 = yield pulser.amplitude(channel_866)
        freq397 = yield pulser.frequency(channel_397)
        freq866 = yield pulser.frequency(channel_866)
    ...
    # @inlineCallbacks
    # def on_to_loading_extra(self):
    #     ss = yield self.cxn.get_server('ScriptScanner')
    #     pulser = yield self.cxn.get_server('Pulser')
    #     channel_397 = "397extra"
    #     channel_866 = "866extra"
    #     ampl397 = yield pulser.amplitude(channel_397)
    #     ampl866 = yield pulser.amplitude(channel_866)
    #     freq397 = yield pulser.frequency(channel_397)
    #     freq866 = yield pulser.frequency(channel_866)
    #     yield ss.set_parameter('Loading','loading_amplitude_397extra',ampl397)
    #     yield ss.set_parameter('Loading','loading_amplitude_866extra',ampl866)
    #     yield ss.set_parameter('Loading','loading_frequency_397extra',freq397)
    #     yield ss.set_parameter('Loading','loading_frequency_866extra',freq866)
    #     #if use_second_397_SD:   #used if there are two doppler cooling beams
    #     #    yield pv.set_parameter('StateReadout','state_readout_amplitude_397Extra',ampl397Extra)
    #     #    yield pv.set_parameter('StateReadout','state_readout_frequency_397Extra',freq397Extra)
    ...
    #     freq397 = yield pulser.frequency(channel_397)
    #     freq866 = yield pulser.frequency(channel_866)
    #     yield ss.set_parameter('StateReadout','state_readout_amplitude_397extra',ampl397)
    #     yield ss.set_parameter('StateReadout','state_readout_amplitude_866extra',ampl866)
    #     yield ss.set_parameter('StateReadout','state_readout_frequency_397extra',freq397)
    #     yield ss.set_parameter('StateReadout','state_readout_frequency_866extra',freq866)
    #     #if use_second_397_SD:   #used if there are two doppler cooling beams
    #     #    yield pv.set_parameter('StateReadout','state_readout_amplitude_397Extra',ampl397Extra)
    #     #    yield pv.set_parameter('StateReadout','state_readout_frequency_397Extra',freq397Extra)
    ...
    #     freq397 = yield pulser.frequency(channel_397)       
    #     freq866 = yield pulser.frequency(channel_866)
    #     yield ss.set_parameter('DopplerCooling','doppler_cooling_amplitude_397extra',ampl397)
    #     yield ss.set_parameter('DopplerCooling','doppler_cooling_amplitude_866extra',ampl866)
    #     yield ss.set_parameter('DopplerCooling','doppler_cooling_frequency_397extra',freq397)
    #     yield ss.set_parameter('DopplerCooling','doppler_cooling_frequency_866extra',freq866)
    #     #if use_second_397_DC:   #used if there are two doppler cooling beams
    #     #    yield pv.set_parameter('DopplerCooling','doppler_cooling_amplitude_397Extra',ampl397Extra)
    #     #    yield pv.set_parameter('DopplerCooling','doppler_cooling_frequency_397Extra',freq397Extra)
    ...
    def on_from_loading(self):
        ...
        yield pulser.frequency(channel_866, freq866)
        yield pulser.amplitude(channel_866, ampl866)
        yield pulser.frequency(channel_397, freq397)
        yield pulser.amplitude(channel_397, ampl397)
        #if doppler_cooling_with_second_397: #used if there are two doppler cooling beams
        #    yield pulser.frequency('397Extra', freq397Extra)
        #    yield pulser.amplitude('397Extra', ampl397Extra)

    # @inlineCallbacks
    # def on_from_loading_extra(self):
    #     ss = yield self.cxn.get_server('ScriptScanner')
    #     pulser = yield self.cxn.get_server('Pulser')
    #     channel_397 = "397extra"
    #     channel_866 = "866extra"
    #     ampl397 = yield ss.get_parameter(('Loading','loading_amplitude_397extra'))
    #     ampl866 = yield ss.get_parameter(('Loading','loading_amplitude_866extra'))
    #     freq397 = yield ss.get_parameter(('Loading','loading_frequency_397extra'))
    #     freq866 = yield ss.get_parameter(('Loading','loading_frequency_866extra'))
    #     yield pulser.frequency(channel_866, freq866)
    #     yield pulser.amplitude(channel_866, ampl866)
    #     yield pulser.frequency(channel_397, freq397)
    #     yield pulser.amplitude(channel_397, ampl397)
    ...
    # @inlineCallbacks
    # def on_from_dc_extra(self):
    #     ss = yield self.cxn.get_server('ScriptScanner')
    #     pulser = yield self.cxn.get_server('Pulser')
    #     channel_397 = "397extra"
    #     channel_866 = "866extra"
    #     ampl397 = yield ss.get_parameter(('DopplerCooling','doppler_cooling_amplitude_397extra'))
    #     ampl866 = yield ss.get_parameter(('DopplerCooling','doppler_cooling_amplitude_866extra'))
    #     freq397 = yield ss.get_parameter(('DopplerCooling','doppler_cooling_frequency_397extra'))
    #     freq866 = yield ss.get_parameter(('DopplerCooling','doppler_cooling_frequency_866extra'))
    #     yield pulser.frequency(channel_866, freq866)
    #     yield pulser.amplitude(channel_866, ampl866)
    #     yield pulser.frequency(channel_397, freq397)
    #     yield pulser.amplitude(channel_397, ampl397)
    ...
    # @inlineCallbacks
    # def on_from_state_extra(self):
    #     ss = yield self.cxn.get_server('ScriptScanner')
    #     pulser = yield self.cxn.get_server('Pulser')
    #     channel_397 = "397extra"
    #     channel_866 = "866extra"
    #     ampl397 = yield ss.get_parameter(('StateReadout','state_readout_amplitude_397extra'))
    #     ampl866 = yield ss.get_parameter(('StateReadout','state_readout_amplitude_866extra'))
    #     freq397 = yield ss.get_parameter(('StateReadout','state_readout_frequency_397extra'))
    #     freq866 = yield ss.get_parameter(('StateReadout','state_readout_frequency_866extra'))
    #     yield pulser.frequency(channel_866, freq866)
    #     yield pulser.amplitude(channel_866, ampl866)
    #     yield pulser.frequency(channel_397, freq397)
    #     yield pulser.amplitude(channel_397, ampl397)
