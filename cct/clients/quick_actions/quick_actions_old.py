...
class actions_widget(QtGui.QWidget):
    def __init__(self,reactor,cxn = None, parent=None):
    	...
    	layout.addWidget(self.todc_button, 2, 0)
    	layout.addWidget(self.fromstate_button, 3, 0)
    	layout.addWidget(self.tostate_button, 4, 0)
