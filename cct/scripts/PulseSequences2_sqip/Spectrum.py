...
class Spectrum(pulse_sequence):
    ...
    scannable_params = {
        ...
        'Spectrum.carrier_detuning' : [(-150, 150, 10, 'kHz'),'spectrum'], #sqip doesn't have this? either manual or imports from drifttracker
        'Spectrum.sideband_detuning' :[(-25, 25, 2, 'kHz'),'spectrum'] #sqip doesn't have this? why is this here? 
              }
