...
class MotionAnalysis(pulse_sequence):
    ...
    def sequence(self):
        ...
        channel_397 = dc.channel_397
        channel_866 = dc.channel_866
        ...
        self.addDDS(channel_397, self.start + WithUnit(1, 'us'), ma.pulse_width_397, freq_397, ma.amplitude_397)
        self.addDDS(channel_866, self.start + WithUnit(1,'us'), ma.pulse_width_397, freq_866, amp_866 )
