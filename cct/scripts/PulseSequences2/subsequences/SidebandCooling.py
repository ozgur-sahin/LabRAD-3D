                ...
                for j in range(Nsb):
                    ...
                    for i in range(Nc):
                        ...
                        self.addSequence(OpticalPumping,
                            ...
                            "OpticalPumping.optical_pumping_frequency_854extra":freq854,
                            "OpticalPumping.optical_pumping_amplitude_854extra":amps854[j],
                            "OpticalPumping.optical_pumping_frequency_729":freq729,
                            "OpticalPumping.optical_pumping_amplitude_729":amps729[j],
                            "OpticalPumping.optical_pumping_requency_866extra":freq866,
                            "OpticalPumping.optical_pumping_amplitude_866extra":amp866,
                            "StatePreparation.channel_729":channels729[j]})
                        #optical pumping sequence
                        self.addSequence(OpticalPumping,{'OpticalPumping.optical_pumping_frequency_729':freq729_op,
                                                        'OpticalPumpingContinuous.optical_pumping_continuous_duration':sbc_op_duration})
                ...
                for i in range(Nc):
                    ...
                    for j in range(Nsb):
                        ...
                        self.addSequence(OpticalPumping,
                            ...
                            "OpticalPumping.optical_pumping_frequency_729":freq729,
                            "OpticalPumping.optical_pumping_amplitude_729":amps729[j],
                            "OpticalPumping.optical_pumping_frequency_866extra":freq866,
                            "OpticalPumping.optical_pumping_amplitude_866extra":amp866,
                            "StatePreparation.channel_729":channels729[j]})
                        #optical pumping sequence
                        self.addSequence(OpticalPumping,{'OpticalPumping.optical_pumping_frequency_729':freq729_op,
