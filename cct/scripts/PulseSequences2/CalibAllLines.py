...
class CalibLine1(pulse_sequence):
    ...
    scannable_params = {'Excitation729.rabi_excitation_frequency' : [(-10, 10, 1, 'kHz'), 'car1',True]}
    ...
    def sequence(self):
        ...
        freq729 = freq729 + p.Excitation729.rabi_excitation_frequency
        amp729 = p.CalibrateLines.amplitude729_line1
        channel729 = p.CalibrateLines.channel_729
        dur729 = p.CalibrateLines.duration729_line1
...
class CalibLine2(pulse_sequence):
    ...
    scannable_params = {'Excitation729.rabi_excitation_frequency':[(-10, 10, 1, 'kHz'),'car2',True]}
    ...
    def sequence(self):
        ...
        channel729 = p.CalibrateLines.channel_729
        dur729 = p.CalibrateLines.duration729_line2
...
class CalibAllLines(pulse_sequence):
    ...
    show_params= ['DriftTracker.line_selection_1',
                ...
                'CalibrateLines.duration729_line1',
                'CalibrateLines.duration729_line2'
                  ]