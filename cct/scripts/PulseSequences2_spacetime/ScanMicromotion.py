...
#     scannable_params = {
#         'MicromotionCalibration.point' : [(1., 1., 1., ''),'micromotion'],
#               }
...
#                     'Excitation729.rabi_excitation_amplitude'
#                     ] 
...
#         carrier_freq_729 = self.calc_freq_from_array(e.line_selection,e.sideband_selection)
#         # amp = e.rabi_excitation_amplitude
