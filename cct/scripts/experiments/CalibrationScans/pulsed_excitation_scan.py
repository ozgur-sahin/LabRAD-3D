...
from cct.scripts.experiments.Experiments729.rabi_flopping_scannable import rabi_flopping_scannable as rf
...
class pulsed_excitation_scan(experiment):
    ...
    def initialize(self, cxn, context, ident):
        ...
        self.agi = self.rm.open_resource(u'usb0::2391::1031::MY44051933::0::INSTR')
        self.agi.write("OUTP OFF")
    ...
    def run(self, cxn, context):
        ...
        if self.parameters.Motion_Analysis.do_radial1_scan:
            ...
            for i,f in enumerate(self.scan):
                ...
                self.agi.write("APPL:SQU {} HZ, 5.0 VPP".format(f))
                time.sleep(1)
                print('1')
