...
'''
The Switch Control GUI lets the user control the TTL channels of the Pulser2
...
class switchWidget(QtGui.QFrame):
    ...
    def connect(self):
        ...
        try:
            ...
            print e
            print 'SWTICH CONTROL: Pulser2 not available'
    ...
    def get_displayed_channels(self):
        '''
        get a list of all available channels from the pulser2. only show the ones
