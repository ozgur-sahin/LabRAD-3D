...
#line 34 "/home/cct/LabRAD/PyQt-x11-gpl-4.10.4/QtDBus/sipQtDBusQDBusError.cpp"

#line 36 "/home/cct/LabRAD/PyQt-x11-gpl-4.10.4/sip/QtCore/qstring.sip"
#include <qstring.h>
#line 38 "/home/cct/LabRAD/PyQt-x11-gpl-4.10.4/QtDBus/sipQtDBusQDBusError.cpp"
...
static sipEnumMemberDef enummembers_QDBusError[] = {
    {sipName_AccessDenied, QDBusError::AccessDenied, 17},
    {sipName_AddressInUse, QDBusError::AddressInUse, 17},
    {sipName_BadAddress, QDBusError::BadAddress, 17},
    {sipName_Disconnected, QDBusError::Disconnected, 17},
    {sipName_Failed, QDBusError::Failed, 17},
    {sipName_InternalError, QDBusError::InternalError, 17},
    {sipName_InvalidArgs, QDBusError::InvalidArgs, 17},
    {sipName_InvalidInterface, QDBusError::InvalidInterface, 17},
    {sipName_InvalidMember, QDBusError::InvalidMember, 17},
    {sipName_InvalidObjectPath, QDBusError::InvalidObjectPath, 17},
    {sipName_InvalidService, QDBusError::InvalidService, 17},
    {sipName_InvalidSignature, QDBusError::InvalidSignature, 17},
    {sipName_LimitsExceeded, QDBusError::LimitsExceeded, 17},
    {sipName_NoError, QDBusError::NoError, 17},
    {sipName_NoMemory, QDBusError::NoMemory, 17},
    {sipName_NoNetwork, QDBusError::NoNetwork, 17},
    {sipName_NoReply, QDBusError::NoReply, 17},
    {sipName_NoServer, QDBusError::NoServer, 17},
    {sipName_NotSupported, QDBusError::NotSupported, 17},
    {sipName_Other, QDBusError::Other, 17},
    {sipName_ServiceUnknown, QDBusError::ServiceUnknown, 17},
    {sipName_TimedOut, QDBusError::TimedOut, 17},
    {sipName_Timeout, QDBusError::Timeout, 17},
    {sipName_UnknownInterface, QDBusError::UnknownInterface, 17},
    {sipName_UnknownMethod, QDBusError::UnknownMethod, 17},
    {sipName_UnknownObject, QDBusError::UnknownObject, 17},
};
